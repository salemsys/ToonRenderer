...
from toon import ToontownGlobals
...
EyelashDict = {'d': '/models/char/dog-lashes',
 ...
 'a': '/models/char/crocodile-lashes'}
...
class ToonHead(DirectObject):
    ...
    def generateToonColor(self, style):
        ...
        if animalType == 'cat' or animalType == 'rabbit' or animalType == 'bear' or animalType == 'mouse' or animalType == 'pig' or animalType == 'crocodile':
